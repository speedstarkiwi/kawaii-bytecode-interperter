...
//LUAVM_SHUFFLE3(a1, a2, a3) a2; a1; a3;
...
typedef struct global_State
{
    ...
    vmvalue2_t<TString*> ttname[LUA_T_COUNT],
    vmvalue2_t<TString*> tmname[TM_N],
    );
...
struct lua_State
{
    ...
    StkId top,
    StkId base,
    vmvalue2_t<global_State*> global,
    CallInfo* ci,
    StkId stack_last,
    StkId stack,
    );
