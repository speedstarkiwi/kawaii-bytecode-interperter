...
#define LUAVM_SHUFFLE4(a1, a2, a3, a4) a2; a4; a3; a1; //01.02.2023
#define LUAVM_SHUFFLE5(a1, a2, a3, a4, a5) a5; a3; a2; a1; a4; //01.02.2023
#define LUAVM_SHUFFLE6(a1, a2, a3, a4, a5, a6) a4; a6; a1; a2; a3; a5; //01.02.2023
#define LUAVM_SHUFFLE3(a1, a2, a3) a2; a1; a3; //01.02.2023
#define LUAVM_SHUFFLE8(a1, a2, a3, a4, a5, a6, a7, a8) a1; a7; a3; a8; a5; a6; a4; a2; //01.02.2023
#define LUAVM_SHUFFLE9(a1, a2, a3, a4, a5, a6, a7, a8, a9) a1; a5; a3; a2; a4; a9; a8; a7; a6; //01.02.2023
...
// clang-format off
#define CommonHeader \
     uint8_t marked = 0; uint8_t tt = 1; uint8_t memcat = 2 
// clang-format on
...
typedef struct TString
{
    ...
    vmvalue2_t<unsigned int> hash; //12
    vmvalue1_t<unsigned int> len; //16
...
typedef struct Udata
{
    ...
    vmvalue1_t<struct Table*> metatable;
...
typedef struct Proto
{
    ...
    LUAVM_SHUFFLE8(
    vmvalue3_t<TValue*> k,
    vmvalue3_t<Instruction*> code,
    vmvalue3_t<struct Proto**> p,
    vmvalue3_t<uint8_t*> lineinfo,
    vmvalue3_t<int*> abslineinfo,
    vmvalue3_t<struct LocVar*> locvars,
    vmvalue3_t<TString**> upvalues,
    vmvalue3_t<TString*> source,
    );

    vmvalue2_t<TString*> debugname; //36
    vmvalue1_t<uint8_t*> debuginsn; //40
...
typedef struct Table
{
    ...
    LUAVM_SHUFFLE4(
    vmvalue1_t<struct Table*> metatable,
    vmvalue1_t<TValue*> array,
    vmvalue1_t<LuaNode*> node,
    GCObject* gclist,
    );
...
#define luaO_nilobject (TValue*)ASLR(0x288B8D8)
